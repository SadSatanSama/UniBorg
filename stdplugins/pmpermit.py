...
text = "`Hello! This is an automated message. \n\nI haven't approved you to PM yet. Please wait for me to look in, otherwise contact me through @satankabot \n\nUntil then please do not spam my PM, you\'ll get blocked and reported!`"
UNIBORG_USER_BOT_WARN_ZERO = text
UNIBORG_USER_BOT_NO_WARN = text
